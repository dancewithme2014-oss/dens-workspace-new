...
export const content = {
  ru: {
    ...
    heroTitle: "Создаю системы с реальным эффектом.",
    kicker: "AI. Автоматизация. Бизнес-системы. Реальные решения.",
    ...
    contactNote: "Если у вас есть задача, которую стоит решить, давайте поговорим.",
