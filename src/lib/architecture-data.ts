...
export const architectureProjects: ArchitectureProject[] = [
  ...
  createArchitecture("golden-house-dubai", "Golden House Dubai", { ru: "Премиальная платформа недвижимости", en: "Premium Property Experience" }, { ru: "Платформа объединяет каталог, контент, заявки и коммуникацию.", en: "The platform connects catalog, content, inquiries and communication." }),
  createArchitecture("chronos", "Chronos", { ru: "Премиальный опыт выбора часов", en: "Luxury Watch Experience" }, { ru: "Проект соединяет каталог, визуальную презентацию и путь к покупке.", en: "The project connects catalog, visual storytelling and purchase intent." }),
];
